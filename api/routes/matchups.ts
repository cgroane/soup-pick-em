...
import { getGames, getRankings, DivisionClassification, SeasonType, getLines, getFbsTeams } from 'cfbd';
import { requireAuth } from "../middlware";

const matchupsRouter = express.Router();
matchupsRouter.use(requireAuth);


matchupsRouter.get('/games', async (req: express.Request<{}, {}, {}, {
  week: string;
  year: string;
...
matchupsRouter.get(`/games/:id`, async (req: express.Request<{ id: string }>, res: express.Response) => {
  try {
...
matchupsRouter.get('/rankings', async (req: express.Request<{}, {}, {}, {
  week: string;
  year: string;
  seasonType: SeasonType;
}>, res: express.Response) => {
...
matchupsRouter.get("/matchups", async (req: express.Request<{}, {}, {}, {
  week?: string;
  year: string;
  seasonType?: SeasonType;
}>, res: express.Response) => {
...
matchupsRouter.get('/cfp-games', async (req: express.Request<{}, {}, {}, { year?: string }>, res: express.Response) => {
  try {
...
matchupsRouter.get('/teams', async (_req: express.Request, res: express.Response) => {
  try {
